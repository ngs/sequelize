module.exports.Factory = function(Sequelize, sequelize) {
  var Factory = {
    ...
    addOneToManyMethods: function(table1, table2, assocName, methodName) {
      ...
      table1.prototype[setterName] = Factory.createOneToManySetter(table1, assocName, methodName || assocName)
      table1.prototype[getterName] = Factory.createOneToManyGetter(table1, table2, assocName, methodName || assocName)
    },
